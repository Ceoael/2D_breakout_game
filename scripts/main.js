...
const touchScreenControl = document.querySelector(".touchScreenControl");
...
function keyDownHandler(e) {
    ...
    if(e.key === "Right" || e.key === "ArrowRight" || e.target.className === "right"){
        rightPressed = true;
    }
    else if (e.key === "Left" || e.key === "ArrowLeft" || e.target.className === "left"){
        leftPressed = true;
    }
}
...
if (window.mobilecheck() === true){
    console.log("przegladaraka mobilna");
    touchScreenControl.classList.remove("unactive");
}

// CONTROL EventListeners
document.addEventListener("keydown", keyDownHandler);
document.addEventListener("keyup", keyUpHandler);
document.querySelector(".touchScreenControl").addEventListener("touchstart", keyDownHandler);
document.querySelector(".touchScreenControl").addEventListener("touchend", keyUpHandler);
